...
//=========== Project =================
const CustomerRoutes = require("./routes/Project/Customer.routes.js");
const DettailProjectRoutes = require("./routes/Project/DetailProject.routes.js");

app.use("/api/Project/Customer", CustomerRoutes(io));
app.use("/api/Project/DetailProject", DettailProjectRoutes(io));

//=========== Maintaince =================
const MachineRoutes = require("./routes/Maintenance/Machine.routes.js");
const DetailMaintenanceRoutes = require("./routes/Maintenance/Maintenance.routes.js");
...
app.use("/api/Maintenance/Machine", MachineRoutes(io));
app.use("/api/Maintenance/DetailMaintenance", DetailMaintenanceRoutes(io));
