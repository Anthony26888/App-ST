      ...
      <v-container>
        <v-list density="compact">
          ...
          <v-list-item
            color="primary"
            value="option-1"
            @click="(TabMain = false), (TabUser = true)"
          >
          ...
          <v-list-item
            color="primary"
            value="option-2"
            @click="(TabMain = false), (TabRegister = true)"
          >
            <template v-slot:prepend>
          ...
          <v-list-item color="primary" value="option-3" @click="DialogRemoveCheckBOM = true">
            <template v-slot:prepend>
  ...
  <v-dialog v-model="DialogRemoveInventory" width="400">
    <v-card max-width="400" prepend-icon="mdi-delete" title="Xoá dữ liệu">
      ...
      <template v-slot:actions>
        <v-btn @click="DialogRemoveInventory = false" variant="tonal">Huỷ</v-btn>
        <v-btn class="bg-red" @click="RemoveInventory(); DialogRemoveInventory = false">Xoá</v-btn>
      </template>
    </v-card>
  </v-dialog>
  <v-dialog v-model="DialogRemoveCheckBOM" width="400">
    <v-card max-width="400" prepend-icon="mdi-delete" title="Xoá dữ liệu">
      ...
      <template v-slot:actions>
        ...
        <v-btn class="bg-red" @click="RemoveCheckBOM(); DialogRemoveCheckBOM = false">Xoá</v-btn>
      </template>
    </v-card>
  </v-dialog>
</template>
