  ...
  <div>
    ...
    >
      <v-row>
        ...
        <v-col cols="6">
          <InputDate label="Ngày bắt đầu" v-model="NgayBatDau_Edit" />
        </v-col>
        <v-col cols="6">
          <InputDate
    ...
    >
      <v-row>
        ...
        <v-col cols="6">
          <InputDate label="Ngày bắt đầu" v-model="NgayBatDau_Add" />
        </v-col>
        <v-col cols="6">
          <InputDate
            label="Ngày bảo trì tiếp theo"
...
const SaveAdd = async () => {
  ...
  try {
    const response = await axios.post(
      `${Url}/Maintenance/Schedule/Add-item`,
      formData,
    );
...
const SaveEdit = async () => {
  ...
  try {
    const response = await axios.put(
      `${Url}/Maintenance/Schedule/Edit-item/${GetID.value}`,
      formData,
    );
...
const DeleteItem = async () => {
  ...
  try {
    const response = await axios.delete(
      `${Url}/Maintenance/Schedule/Delete-item/${GetID.value}`,
    );
