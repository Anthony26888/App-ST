      ...
      <v-col cols="12" md="6" class="d-none d-md-flex">
        <div class="login-image-container">
          <div class="login-image-overlay">
            <h2 class="text-h3 font-weight-bold mb-4 gradient-text">Chào mừng đến với hệ thống</h2>
            <p class="text-h6 gradient-text-subtitle">Quản lý và theo dõi thông tin một cách hiệu quả</p>
          </div>
        </div>
      </v-col>
