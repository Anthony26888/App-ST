...
import { useManufactureBoxBuild } from "@/composables/Manufacture/useManufactureBoxBuild";
...
const { manufactureBoxBuild, manufactureBoxBuildError } = useManufactureBoxBuild(id);
...
watch(manufactureBoxBuildError, (error) => {
  if (error) {
    console.error("ManufactureBoxBuild Error:", error);
  }
});
